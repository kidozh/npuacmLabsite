...
class PsutilStats(object):
    ...
    def loadSummaryData(self):
        ...
        summary_data['uptime'] = self.loadCommandUptime()
        summary_data['df'] = self.loadCommandDf()
        summary_data['net_sent'] = psutil.net_io_counters(pernic=False).bytes_sent
        summary_data['net_recv'] = psutil.net_io_counters(pernic=False).bytes_recv
        return summary_data
